...
// Configure project root to prevent looking for parent node_modules
...
// Update watchFolders to only include necessary directories and prevent parent directory watching
config.watchFolders = [__dirname, VIRTUAL_ROOT, VIRTUAL_ROOT_UNRESOLVED];

// Add resolver configuration to prevent parent directory resolution issues
config.resolver = {
  ...config.resolver,
  blockList: [
